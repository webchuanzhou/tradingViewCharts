...
class dataUpdater {
  ...
  updateData() {
    // console.log(this.requestsPending,'avcc')
  ...
  updateDataForSubscriber(listenerGuid) {
    // console.log(this.requestsPending,'avcc1')
  ...
  onSubscriberDataReceived(listenerGuid, bars) {
    // console.log(this.requestsPending,'avcc2')
  ...
  periodLengthSeconds(resolution, requiredPeriodsCount) {
    // console.log(this.requestsPending,'avcc3')
