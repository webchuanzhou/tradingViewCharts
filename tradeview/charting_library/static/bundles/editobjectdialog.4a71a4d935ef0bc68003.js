webpackJsonp([17, 27], {
    357 : function(t, e, i) {
        "use strict"; (function(e) {
            ...
            o.prototype._onDestroy = function(t, e) {
                var i, o, n = (e || {}).undoChanges;
                $(window).unbind("keyup.hidePropertyDialog"),
                n ? (i = this._undoCheckpoint ? this._undoCheckpoint: this._undoCheckpointOnShow) && this._model.undoToCheckpoint(i) : this._source.hasAlert.value() && (o = this._source, setTimeout(function() {
            ...
            o.prototype.switchTab = function(t, e) {
                var i, o;
                if (this._tabs) return i = null,
                t ? t = t.valueOf() : null === t && (t = void 0),
                "string" == typeof t && $.each(this._tabs,
                function(e, o) {
                    if (o.name === t) return i = o,
                    !1
                }),
                "object" == typeof t && $.each(this._tabs,
                function(e, o) {
                    if (t === o || $(o.labelObject).is(t) || $(o.wrapperObject).is(t)) return i = o,
                    !1
                }),
                i || (i = this._tabs[~~t]),
                !!i && ($.each(this._tabs,
                ...
                }), e && (o = this.activeTabSettingsName()) && TVSettings.setValue(o, i.name), this._dialog.height() + 100 > $(window).height() && !i.isScrollable && this.makeScrollable(i), $(":focus").blur(), !0)
            },
            //update -88
            ...
            o.prototype.appendToTab = function(t, e, i, o, n, a) {
                var s, r;
                $(t).is("table") && !$(t).find("tr").size() || (this._tabs || (this._tabs = []), $.each(this._tabs,
                function(t, i) {
                    if (i.name === e) return s = t,
                    !1
                }), void 0 === s && (this._tabs.push({
                    name: e,
                    localizedName: $.t(e),
                    objects: $(),
                    displayPriority: 0,
                    ...
                    callback: n ? a ||
                    function() {}: null
                }), s = this._tabs.length - 1), r = this._tabs[s], r.objects = r.objects.add(t), r.displayPriority = Math.max(r.displayPriority || 0, i || 0), r.defaultOpen = Math.max(r.defaultOpen || 0, o || 0))
            },
            o.prototype.insertTabs = function() {
                function t(t) {
                    a && a === t.name && (t.defaultOpen = Math.max(~~t.defaultOpen, p.TabOpenFrom.UserSave)),
                    (!o || ~~o.defaultOpen < ~~t.defaultOpen) && (o = t),
                    t.labelObject = $('<a href="#" class="properties-tabs-label tv-tabs__tab"></a>').text(t.localizedName).appendTo(i._tabContainer),
                    t.labelObject.on("mousedown",
                    function(t) {
                        function e(t) {
                            var e = 5;
                    ...
                    t.objects.each(function(i, o) {
                        var n = $(o);
                        n.is("table") ? (n.data("layout-separated") && (t.wrapperObject = t.wrapperObject.add('<div class="properties-separator"></div>').add(e = $('<div class="main-properties"></div>')), n.removeData("layout-separated")), e.append(n), n.children("tbody").each(function(i, n) {
                            if (0 !== i && $(n).data("layout-separated")) {
                                t.wrapperObject = t.wrapperObject.add('<div class="properties-separator"></div>').add(e = $('<div class="main-properties"></div>'));
                                var a = $(o).clone(!0, !1).appendTo(e);
                                a.children().remove(),
                                a.append(n),
                ...
                var i, o, n, a;
                this._tabs && (this._tabs.sort(function(t, e) {
                    return (e.displayPriority || 0) - (t.displayPriority || 0)
                }), i = this, o = null, n = this.activeTabSettingsName(), n && (a = TVSettings.getValue(n)), $.each(this._tabs,
                function(i, o) {
                    o.isButton ? e(o) : t(o)
                }), this.switchTab(o))
            },
            o.prototype.activeTabSettingsName = function() {
                var t = this._source;
                if (t) return t instanceof s ? "properties_dialog.active_tab.chart": t instanceof n ? "properties_dialog.active_tab.drawing": t instanceof a ? "properties_dialog.active_tab.study": void 0
            },
            o.prototype.show = function(t) {
                ...
                if (e.enabled("property_pages") && (f = i(693), t = t || {},
                v = t.onWidget || !1, TradingView.isInherited(this._source.constructor, s) && d("GUI", "Series Properties"), TradingView.isInherited(this._source.constructor, a) && (g = !this._source.isPine() || this._source.isStandardPine() ? this._source.metaInfo().description: "Custom Pine", d("GUI", "Study Properties", g)), h(this._source) && d("GUI", "Drawing Properties", this._source.name()), TradingView.isInherited(this._source.constructor, r) && this._model.setSelectedSource(this._source), _ = f.createStudyStrategyPropertyPage(this._source, this._model), m = f.createInputsPropertyPage(this._source, this._model), y = f.createStylesPropertyPage(this._source, this._model), b = f.createVisibilitiesPropertyPage(this._source, this._model), T = f.createDisplayPropertyPage(this._source, this._model), m && !m.widget().is(":empty") || y || _)) return C = this,
                w = null !== m,
                ...
                !this._model.readOnly() && _ && _.widget().each(function(t, e) {
                    var i, o, n = +$(e).data("layout-tab-priority");
                ...
                this._model.readOnly() || !w || m.widget().is(":empty") || m.widget().each(function(t, e) {
                    var o, n, a = i(691),
                    s = m instanceof a,
                    r = +$(e).data("layout-tab-priority");
                    TradingView.isNaN(r) && (r = s ? p.TabPriority.Coordinates: p.TabPriority.Inputs),
                    o = ~~$(e).data("layout-tab-open"),
                    n = $(e).data("layout-tab"),
                    void 0 === n && (n = s ? p.TabNames.coordinates: p.TabNames.inputs),
                    C.appendToTab(e, n, r, o)
                }),
                y && y.widget().each(function(t, e) {
                    var o, n, a, s = +$(e).data("layout-tab-priority");
                ...
                F = function() {
                    function t(e) {
                        e._childs && e._childs.length && $.each(e._childs,
                        function(i, o) {
                            "percentage" === o ? e.percentage.listeners().fire(e.percentage) : t(e[o])
                        })
                    }
                    var e, i, o = [];
                    y && "function" == typeof y.defaultProperties && (o = o.concat(y.defaultProperties())),
                    m && "function" == typeof m.defaultProperties && (o = o.concat(m.defaultProperties())),
                    0 === o.length && C._source.properties ? o = [C._source.properties()] : C._source._sessionsStudy && (o = o.concat(C._source._sessionsStudy.properties())),
                    o.length && (e = C._source.priceScale().mode(), $.each(o,
                    function(e, i) {
                        C._model.restoreFactoryDefaults(i),
                        C._source.calcIsActualSymbol && C._source.calcIsActualSymbol(),
                        t(i)
                    }), i = C._source.priceScale(), i && i.modeChanged().fire(e, i.mode()), C._source.properties().minTick && C._source.properties().minTick.listeners().fire(C._source.properties().minTick), C._source.properties().precision && C._source.properties().precision.listeners().fire(C._source.properties().precision), m && m.loadData(), _ && _.loadData(), y.onResoreDefaults && y.onResoreDefaults(), y && y.loadData(), b && b.loadData())
                },
                B = function() {
                    b && b.loadData(),
                    m && m.loadData()
                },
                (!v || window.is_authenticated) && y && "function" == typeof y.createTemplateButton && e.enabled("linetoolpropertieswidget_template_button") ? (M && E[0].appendChild(M.domNode), C._templateButton = y.createTemplateButton({
                    popupZIndex: A,
                    defaultsCallback: F,
                    loadTemplateCallback: B
                }).addClass("tv-left").appendTo(E)) : TradingView.isInherited(this._source.constructor, a) ? (z = [{
                ...
                }], L = $('<a href="#" class="_tv-button tv-left">' + $.t("Defaults") + '<span class="icon-dropdown"></span></a>'), L.on("click",
                function(t) {
                    t.preventDefault();
                    var e = $(this);
                    ...
                    notCloseOnButtons: !0,
                    zIndex: A
                })) : $('<a class="_tv-button tv-left">' + $.t("Defaults") + "</a>").appendTo(E).click(F),
                $('<a class="_tv-button ok">' + $.t("OK") + "</a>").appendTo(E).click(function() {
                    C.hide()
                }),
                $('<a class="_tv-button cancel">' + $.t("Cancel") + "</a>").appendTo(E).on("click",
                function(t) {
                    o(t, !0)
                }),
                D.find("._tv-dialog-title a").on("click", o),
                $(window).bind("keyup.hidePropertyDialog",
                function(t) {
                    13 === t.keyCode && "textarea" !== t.target.tagName.toLowerCase() && (C._templateButton && C._templateButton.trigger("hide-popup"), C.hide())
                }),
                $("select", P).each(function() {
                    var t = $(this),
                ...
                l.emit("edit_object_dialog", {
                    objectType: this._source === this._model.mainSeries() ? "mainSeries": this._source instanceof n ? "drawing": this._source instanceof a ? "study": "other",
    ...
    691 : function(t, e, i) {
        ...
        o.prototype.createPriceEditor = function(t) {
            ...
            }], i = "Change " + n.title() + " point price", o = this.createStringBinder(l, t, e, !1, this.model(), i), o.addFormatter(function(t) {
                return a.format(t)
            }), this.bindControl(o)),
            l
        },
        ...
        o.prototype.prepareLayoutForTable = function(t) {
            var e, i, o, n, a, s = this._linetool.points(),
            r = s.length;
            for (e = 0; e < s.length; e++) i = s[e],
            (o = this._linetool.properties().points[e]) && (n = e || r > 1 ? " " + (e + 1) : "", a = this._createPointRow(i, o, n), a.appendTo(t))
        },
    ...
    823 : function(t, e, i) {
        "use strict"; (function(t) {
            ...
            function d() {
                return function(t) {
                    for (var e = t,
                    i = t.replace(/[^\u0000-\u007F]/, ""); i.length !== e.length;) e = i,
                    i = e.replace(/[^\u0000-\u007F]/, "");
                    return i
                }
            }
            ...
            function m(t, e, i, o, n, a, s) {
                ...
                this._mainSeries.dataEvents().barReceived().subscribe(this,
                function() {
            ...
            function D(e, i, o, n, a, s) {
                function r(t, e) {
                    ...
                    n = c._property.value(); (i <= n && n <= o || i < e.value && e.value < o) && c.setValueToProperty(e.value)
                }
                function l(t, e) {
                    c.setValueToProperty(e.value)
                }
                isNumber(i.value()) || (W.logWarn("Property cannot be binded to control, bad value (expect number): " + i.value()), i = new t),
                U.call(this, e, i, o, n, a);
                var c = this;
                o && (s ? (e.bind("slidechange", r), e.bind("slide", r)) : (e.bind("slidechange", l), e.bind("slide", l))),
                e.bind("slidestart",
                function(t, e) {
                    n.beginUndoMacro(a)
                }),
            ...
            function O(t, e, i, o, n, a, s, r) {
                ...
                }), $(r).is(":checked") ? (l._control.slider("enable"), $(l._inputsText[0]).prop("disabled", !1), $(l._inputsText[1]).prop("disabled", !1)) : (l._control.slider("disable"), $(l._inputsText[0]).prop("disabled", !0), $(l._inputsText[1]).prop("disabled", !0))),
                a && ($(a[0]).val(this._control.slider("values", 0)), $(a[1]).val(this._control.slider("values", 1)), t.slider({
                    slide: function(t, e) {
                        $(a[0]).val(e.values[0]),
                        $(a[1]).val(e.values[1])
                    }
                    ...
                    $(this).on("keydown",
                    function(t) {
                        parseInt($(a[0]).val()) < l._transformers[0] ? $(a[0]).val(l._transformers[0]) : parseInt($(a[1]).val()) > l._transformers[1] && $(a[1]).val(l._transformers[1]),
                ...
                function(t) {
                    parseInt($(this).val()) < l._transformers[0] ? $(this).val(l._transformers[0]) : parseInt($(this).val()) > l._transformers[1] && $(this).val(l._transformers[1]),
                ...
                t.slider({
                    stop: function(t, e) {
                        a && ($(a[0]).val(l._control.slider("values", 0)), $(a[1]).val(l._control.slider("values", 1))),
                        l.setValueToProperty(l._control.slider("values"), e.handle)
                    },
                    start: function(t, e) {
                        a && ($(a[0]).val(l._control.slider("values", 0)), $(a[1]).val(l._control.slider("values", 1))),
            ...
            n.prototype.loadData = function() {
                var t, e, i;
                for (t = 0; t < this._bindings.length; t++) e = this._bindings[t],
                e.properties ? (i = e.properties(), e.setValue(i[0], 0), e.setValue(i[1], 1)) : e.property && (e.transparencyProperty && e.transparencyProperty() ? e.applyOldTransparency() : e.setValue(e.property().value()))
            },
            n.prototype.saveData = function() {
                var t, e;
                for (this._model.beginUndoMacro(), t = 0; t < this._bindings.length; t++) e = this._bindings[t],
            ...
            n.prototype.createTextEditor = function(t, e) {
                ...
                return t && (i.width = t),
                e && (i.height = e),
                $(document.createElement("textarea")).css(i).addClass("tv-control-input")
            },
            ...
            n.prototype.createLabeledCell = function(t, e, i) {
                var o, n, a, s, r = null;
                return "number" == typeof t.valueOf() ? (r = t, o = e, n = i) : (o = t, n = e),
                o += "",
                a = this._labelToId(o),
                s = $("<td>"),
                $("<label>").html(o.length > 0 ? $.t(o) : "").attr("for", a).appendTo(s),
                r && s.attr("colspan", r),
                n && n.attr("id", a),
                s
            },
            ...
            v.prototype.value = function() {
                ...
                if (this._transformFunction) if (Array.isArray(this._transformFunction)) for (t = 0; t < this._transformFunction.length; t++) e = this._transformFunction[t](e);
            ...
            v.prototype.setValueToProperty = function(t) {
                this._setter ? this._setter.call(this, this.value()) : this._undoModel.setProperty(this._property, t, this._undoText),
                this._changed = !1
            },
            inherit(g, v),
            inherit(_, U),
            ...
            m.prototype.value = function() {
                var t, e, i;
                return this._disabled ? (this._control.attr("disabled", !0), null) : (t = this._control.val(), e = this._toIntTransformer(t), e < 0 && (e = 0), i = this._mainSeries.bars().size(), i <= e && (e = i - 1), 1e3 * V(this._mainSeries.bars().valueAt(V(this._mainSeries.bars().lastIndex()) - e))[TradingView.TIME_PLOT])
            },
            m.prototype.setValue = function(t) {
                var e, i, o;
                return this._disabled || null == t ? void this._control.attr("disabled", !0) : t < 0 ? (this._control.val( - t), void this._property.setValue(this.value())) : null === (e = this._mainSeries.data().plotValueToTimePointIndex(t / 1e3, TradingView.TIME_PLOT, z.FromRight)) ? void(this._disabled = !0) : (i = V(this._mainSeries.bars().lastIndex()), o = i - e, void(this._control.val() !== "" + o && this._control.val(o)))
            },
            inherit(y, U),
            ...
            b.prototype.value = function() {
                ...
                return this._transformFunction && (t = this._transformFunction(t)),
                t
            },
            ...
            C.prototype.setValue = function(t) {
                ...
                i = t ? "enable": "disable", o = this.control().data("hides"), o ? o.closest("td").css(e) : (n = this.control(), n.parent().parent().data("visible", t).find("td").filter(function() {
                    var t = $(this);
            ...
            k.prototype.applyOldTransparency = function() {
                var t, e, i;
                this.transparencyProperty() && (H.isHexColor(this.property().value()) ? (t = this.transparencyProperty().value ? this.transparencyProperty().value() : this.transparencyProperty(), e = B(this.property().value()), i = (100 - t) / 100, this.control().val(F(A(e, i)))) : this.control().val(this.property().value()), this.control().change())
            },
            ...
            inherit(P, C),
            P.prototype.onIntervalChanged = function() { + this._intervalProperty.value() < 1440 ? this._control.attr({
                    disabled: !1,
            ...
            P.prototype.value = function() {
                return this._control.is(":disabled") ? this._property.value() : C.prototype.value.call(this)
            },
            ...
            O.prototype.setValueToProperty = function(t, e) { ($(e).hasClass("from") || "from" === e) && (this._undoModel.beginUndoMacro(this._undoText[0]), this._undoModel.setProperty(this._propFrom, t[0], this._undoText[0]), this._propFrom.setValue(t[0], 0), this._undoModel.endUndoMacro()),
            ...
            O.prototype.destroy = function() {
                this._propFrom && this._propTo && (this._propFrom.listeners().unsubscribe(this, U.prototype.propertyChanged), this._propTo.listeners().unsubscribe(this, U.prototype.propertyChanged))
            },
            inherit(I, U),
            ...
            I.prototype.setValue = function(t) {
                ...
                this._control.each(function() {
                    ...
                    t.attr("checked", i),
                    t.parents("label").toggleClass("active", i)
                })
            },
            e.PropertyPage = n,
    ...
    825 : function(t, e, i) {
        ...
        n.prototype.createOneColorForAllLinesWidget = function() {
            ...
            return this.bindControl(new r(l(t), this._linetool.properties().collectibleColors, !0, this.model(), "Change All Lines Color", 0)),
            {
        ...
        n.prototype.addOneColorPropertyWidget = function(t) {
            ...
            i = $("<tr>");
            i.append($("<td>")).append(e.label).append(e.editor),
            i.appendTo(t)
        },
        n = o(n),
    ...
    827 : function(t, e, i) {
        "use strict";
        function o(t) {
            return t in $.fn ? Promise.resolve() : (s || (s = new Promise(function(t) {
                i.e(31).then(function(e) {
                    i(831),
                    t()
                }.bind(null, i)).
                catch(i.oe)
    ...
    828 : function(t, e) {
        t.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 13 13" width="13" height="13"><path d="M5.182 6.596l-3.889-3.889-.707-.707 1.414-1.414.707.707 3.889 3.889 3.889-3.889.707-.707 1.414 1.414-.707.707-3.889 3.889 3.889 3.889.707.707-1.414 1.414-.707-.707-3.889-3.889-3.889 3.889-.707.707-1.414-1.414.707-.707 3.889-3.889z"/></svg>'
    },
    829 : function(t, e, i) {
        "use strict";
        function o(t) {
        ...
        function n(t) {
            var e, i, o, n = [];
            for (e = 0, i = t; e < i.length; e++) o = i[e],
            null !== Object(l.tryParseRgb)(o) && n.push(o);
            return n
        }
        function a(t, e) {
            void 0 === e && (e = {});
    ...
    836 : function(t, e) {
        t.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 8" width="16" height="8"><path d="M0 1.475l7.396 6.04.596.485.593-.49L16 1.39 14.807 0 7.393 6.122 8.58 6.12 1.186.08z"/></svg>'
    },
    845 : function(t, e, i) {
        "use strict";
        function o(t) {
            var e, i, o = (t + "").match(/(?:\.(\d+))?(?:[eE]([+-]?\d+))?$/);
            return null === o ? 0 : (e = o[1] ? o[1].length: 0, i = o[2] ? parseInt(o[2], 0) : 0, Math.max(0, e - i))
        }
        function n(t) {
            return t = Math.abs(t),
        ...
        function a(t, e) {
            ...
            o = i && i.step,
            a = 0,
            a = i.parser ? i.parser(t.val()) : Object(p.isInteger)(o) ? parseInt(t.val(), 10) : parseFloat(t.val()),
            isNaN(a) && (a = 0),
            s = n(o),
            r = Math.max(s, n(a)),
            l = e(a, r),
        ...
        function s(t) {
            ...
            function(t, e) {
                ...
                return void 0 !== o && null !== o && o < n && (n = t),
                n
            })
        }
        function r(t) {
            ...
            function(t, e) {
                var n = (Math.round(t * e) - Math.round(i * e)) / e;
                return void 0 !== o && null !== o && n < o && (n = t),
                n
            })
        }
        var l, c, p, u;
        ...
        $.fn.TVTicker = function(t) {
            ...
            this.each(function() {
                ...
                a.data("TVTicker", l),
                n || (e = $('<div class="tv-ticker">').appendTo(a.parent()), i = $('<div class="tv-ticker__btn tv-ticker__btn--up">').html(u).appendTo(e), o = $('<div class="tv-ticker__btn tv-ticker__btn--down">').html(u).appendTo(e), e.on("mousedown",
                function(t) {
                    t.preventDefault(),
                    a.focus()
                }), i.click(function() {
                    ...
                    a.is(":disabled") || (38 === t.keyCode ? i.addClass("i-active") : 40 === t.keyCode && o.addClass("i-active"))
                }), a.keyup(function(t) {
                    a.is(":disabled") || (38 === t.keyCode ? (s(a), i.removeClass("i-active")) : 40 === t.keyCode && (r(a), o.removeClass("i-active")))
        ...
        a = function(t, e, o) {
            ...
            u = function(s, u, h) {
                function f(e) {
                    ...
                    i.is(y) || i.is(t) || i.is(".charts-popup-tab-headers, .charts-popup-itemheader") || c()
                }
                function v(t) {
                    if (p.preventFirstProcessClick) return void(p.preventFirstProcessClick = !1);
                    var e = $(t.target).parents().andSelf();
                    e.is(".charts-popup-tab-headers, .charts-popup-itemheader") || o.notCloseOnButtons && e.is(".icon-delete") || c()
                }
                function g(t) {
                    t.keyCode === n && c()
                }
                function _(e, n, s) {
                    ...
                    if (e instanceof a.TabGroup) {
                        ...
                        return 1 !== e.tabs.length || e.tabs[0].title ? (r = $('<div class="charts-popup-tab-group"></div>').appendTo(s), l = $('<div class="charts-popup-tab-headers"></div>').appendTo(r), c = null, void $.each(e.tabs || [],
                        function(t, i) {
                            var o, n;
                            i.items && i.items.length && (o = $('<div class="charts-popup-tab"></div>').hide().appendTo(r), $.each(i.items,
                            function() {
                                _(this, void 0, o)
                            }), n = $('<span class="charts-popup-tab-header">').append($('<a href="javascript://" class="charts-popup-tab-header-label">').text(i.name)).appendTo(l), n.on("click",
                            function(t) {
                                n.is(".active") || (l.find(".charts-popup-tab-header.active").removeClass("active"), n.addClass("active"), r.find(".charts-popup-tab").hide(), o.show(), t && t.preventDefault(), "function" == typeof e.onChange && e.onChange.call(e, i.name))
                            }), c && !i.active || (c = n, l.find(".charts-popup-tab-header.active").removeClass("active"), n.addClass("active"), r.find(".charts-popup-tab").hide(), o.show()))
                        })) : void $.each(e.tabs[0].items,
                        function() {
                            _(this, void 0, s)
                        })
                    }
                    return e instanceof a.Group ? (p = $('<div class="charts-popup-group"></div>').appendTo(s), e.title && (u = $('<div class="charts-popup-itemheader"></div>').text(e.title).prepend($('<span class="charts-popup-itemheader-icon"></span>')), e.collapsible && (p.addClass("charts-popup-group-collapsible"), p.toggleClass("collapsed", e.collapsed), u.on("click",
                    function() {
                        p.toggleClass("collapsed"),
                        "function" == typeof e.onChange && e.onChange(p.hasClass("collapsed")),
                        y.height() === parseInt(y.css("max-height")) ? y.addClass("popup-menu-scroll-y") : y.height() < parseInt(y.css("max-height")) && y.removeClass("popup-menu-scroll-y")
                    })), p.append(u)), void $.each(e.items,
                    function(t) {
                        _(this, 1, p)
                    })) : e instanceof a.Header ? void s.append($('<div class="charts-popup-itemheader"></div>').text(e.title)) : e.separator ? (d = $('<span class="separator"></span>'), void s.append(d)) : (d = $('<a class="item">'), e.url && d.attr("href", e.url), e.target && d.attr("target", e.target), n || d.addClass("first"), "function" == typeof e.active ? e.active(e) && d.addClass("active") : e.active && d.addClass("active"), e.addClass && d.addClass(e.addClass), e.addData && d.data(e.addData), e.disabled && d.addClass("disabled"), "function" == typeof e.action && (h = e.action, f = function(t) {
                        $(t.target).parents().andSelf().is(C) || (h.apply(d, arguments), !e.url && t && "function" == typeof t.preventDefault && t.preventDefault())
                    },
                    o.upAction ? d.bind("mouseup", f) : d.bind("click", f)), e.date ? (v = $('<span class="title"></span>').appendTo(d), $('<span class="date"></span>').text(e.date || "").appendTo(d)) : e.icon && !o.svg ? (g = $('<span class="icon"></span>').appendTo(d), g.css("background-image", e.icon.image || ""), e.icon.offset && g.css("background-position", "string" == typeof e.icon.offset ? e.icon.offset: e.icon.offset.x + "px " + e.icon.offset.y + "px"), v = $('<span class="title"></span>').appendTo(d)) : !0 === o.svg && e.svg ? (o.wrapIcon ? d.append($('<span class="icon-wrap">').addClass(e.iconClass).append(e.svg)) : d.append(e.svg), v = $('<span class="title"></span>').appendTo(d)) : e.iconClass ? (d.append($('<span class="icon"></span>').addClass(e.iconClass)), v = $('<span class="title"></span>').appendTo(d)) : v = $('<span class="title-expanded"></span>').appendTo(d), e.html ? v.html(e.html) : v.text(TradingView.clean(e.title, !0) || ""), m = $('<span class="shortcut"></span>').appendTo(d), e.shortcut && m.text(e.shortcut.keys), "function" == typeof e.deleteAction && (b = e.deleteAction, T = e.deleteAction.title || $.t("Delete"), C = $('<span class="icon-delete">'), C.html(i(828)), C.attr("title", T), C.on("click",
                    function(t) {
                        b.apply(d, arguments),
                        t.preventDefault()
                    }), d.append(C)), e.buttons instanceof Array && e.buttons.length && e.buttons.forEach(function(t) {
                        t.el instanceof $ || (t.el = $(t.el)),
                        t.el.appendTo(d),
                        t.handler && t.el.on("click",
                        function(e) {
                            t.handler.apply(d, arguments)
                        })
                    }), void 0 !== e.counter && ("function" == typeof e.counter ? (w = $('<span class="counter"></span>').html(e.counter()), w.appendTo(d)) : (x = e.counterBlue ? "blue": "", $('<span class="counter"></span>').text(e.counter + "").addClass(x).appendTo(d))), s.append(d), void t.data("popup-menu", s))
                }
                var m, y, b, T, C, w, x, k, D, P, S, M, O, I, V, E, N, A, F, B, z, L, R, H, j, U, W = s.target.ownerDocument,
                G = W.defaultView,
                q = u || e;
                if ("function" == typeof q && (q = q()), $(this).hasClass("open") || $(this).hasClass("active")) return s.preventDefault(),
                c(),
                void(m = p.scrollTop);
                switch (c = function() {
                ...
                t.addClass("active open " + o.activeClass), y = $('<div class="charts-popup-list">'), o.addClass && y.addClass(o.addClass), o.zIndex && y.css("z-index", o.zIndex), b = y, o.listInner && (b = $('<div class="list-inner">').appendTo(b)), o.listTable && (b = $('<div class="list-table">').appendTo(b)), $.each(q,
                function(t) {
                    _(this, t, b)
                }), r || (p.preventFirstProcessClick = !0), $(W).on("click", v), $(W).on("mousedown", f), W.addEventListener("keydown", g, !1), Modernizr.touch && $(W).on("touchstart.chartgui", f), o.upAction && $(W).on("selectstart.popup-menu",
                function() {
                    return ! 1
                }), y.appendTo(W.body), T = $(G).width(), C = Math.min($(G).height(), $("body").height()), w = t.outerWidth(), x = t.outerHeight(), k = t.offset(), m = $(G).scrollTop() || 0, k.top -= m, k.top = Math.round(k.top), k.left = Math.round(k.left), D = y.outerWidth(), P = y.outerHeight(), S = void 0 !== o.viewportSpacing ? o.viewportSpacing: 10, M = o.popupSpacing ? ~~o.popupSpacing: 1, O = o.popupDrift ? ~~o.popupDrift: 0, I = P - y.height(), V = "down", o.direction && (V = "function" == typeof o.direction ? o.direction() : o.direction), E = !!o.reverse, "down" === V ? (N = C - k.top - x - M - S - I, A = k.top - M - S - I, N < Math.max(P || 0, 100) && A > N && (V = "up")) : "right" === V && (F = T - k.left - w - M - S - I, B = k.left - M - S - I, F < Math.max(D || 0, 100) && B > F && (V = "left")), V) {
                case "down":
                case "up":
                    "down" === V ? y.css("top", k.top + x + M + "px") : y.css("bottom", C - k.top + M + "px").css("top", "auto"),
                    E ? y.css("left", Math.max(k.left + O + w - D, S) + "px").css("right", "auto") : y.css("left", k.left + O + "px").css("right", "auto");
                    break;
                case "right":
                case "left":
                    M = Math.max(M, 4),
                    "right" === V ? y.css("left", Math.floor(k.left + w + M) + "px").css("right", "auto") : y.css("left", Math.floor(Math.max(k.left - D - M, S)) + "px").css("right", "auto"),
                    E ? y.css("top", Math.floor(Math.max(k.top + O + x - P, S)) + "px") : y.css("top", Math.floor(k.top + O) + "px")
                }
                for (y.show(), z = k.top, "up" === V || {
                    left: 1,
                    right: 1
                } [V] && E ? "up" !== V ? z += x: z -= x + M + I + S: z = C - z - x - 2 * M - I, y.height() > z && y.addClass("popup-menu-scroll-y"), y.css("max-height", z + "px"), o.careRightBorder && (L = T + $(G).scrollLeft(), parseInt(y.css("left")) + y.width() + S > L && y.css("left", L - y.width() - S + "px").css("right", "auto")), o.careBottomBorder && parseInt(y.css("top")) + y.height() + S > C + m && y.css("top", C - y.height() - S + m + "px"), H = t.parents().andSelf(), j = H.size(); j--;) if ("fixed" === H.eq(j).css("position")) {
                    R = H.eq(j);
                    break
                }
                R && (U = y.offset(), y.css({
                    position: "fixed",
                    left: U.left - $(W).scrollLeft(),
                    right: "auto"
                })),
        ...
        function(s) {
            ...
            return t.widget("ui.slider", t.ui.mouse, {
                ...
                _createHandles: function() {
                    ...
                    a = [];
                    for (i = o.values && o.values.length || 1, n.length > i && (n.slice(i).remove(), n = n.slice(0, i)), e = n.length; e < i; e++) a.push("<span tabindex='0'></span>");
                ...
                _mouseCapture: function(e) {
                    ...
                    o = this._normValueFromMouse(i), n = this._valueMax() - this._valueMin() + 1, this.handles.each(function(e) {
                        var i = Math.abs(o - c.values(e)); (n > i || n === i && (e === c._lastChangedValue || c.values(e) === p.min)) && (n = i, a = t(this), s = e)
                    }), !1 !== this._start(e, s) && (this._mouseSliding = !0, this._handleIndex = s, this._addClass(a, null, "ui-state-active"), a.trigger("focus"), r = a.offset(), l = !t(e.target).parents().addBack().is(".ui-slider-handle"), this._clickOffset = l ? {
                        left: 0,
                        top: 0
                    }: {
                    ...
                    this.handles.hasClass("ui-state-hover") || this._slide(e, s, o), this._animateOff = !0, !0))
                },
                ...
                _uiHash: function(t, e, i) {
                    ...
                    return this._hasMultipleValues() && (o.value = void 0 !== e ? e: this.values(t), o.values = i || this.values()),
                    o
                },
                ...
                _slide: function(t, e, i) {
                    var o, n = this.value(),
                    a = this.values();
                    this._hasMultipleValues() && (o = this.values(e ? 0 : 1), n = this.values(e), 2 === this.options.values.length && !0 === this.options.range && (i = 0 === e ? Math.min(o, i) : Math.max(o, i)), a[e] = i),
                ...
                values: function(e, i) {
                    ...
                    for (o = this.options.values, n = arguments[0], a = 0; a < o.length; a += 1) o[a] = this._trimAlignValue(n[a]),
                    this._change(null, a);
                    this._refreshValue()
                },
                ...
                _trimAlignValue: function(t) {
                    ...
                    o = t - i;
                    return 2 * Math.abs(i) >= e && (o += i > 0 ? e: -e),
                ...
                _refreshValue: function() {
                    var e, i, o, n, a, s = this.options.range,
                    r = this.options,
                    l = this,
                    ...
                    this._hasMultipleValues() ? this.handles.each(function(o) {
                        ...
                        t(this).stop(1, 1)[c ? "animate": "css"](p, r.animate),
                        ...
                        e = i
                    }) : (o = this.value(), n = this._valueMin(), a = this._valueMax(), i = a !== n ? (o - n) / (a - n) * 100 : 0, p["horizontal" === this.orientation ? "left": "bottom"] = i + "%", this.handle.stop(1, 1)[c ? "animate": "css"](p, r.animate), "min" === s && "horizontal" === this.orientation && this.range.stop(1, 1)[c ? "animate": "css"]({
                        width: i + "%"
                    },
                    r.animate), "max" === s && "horizontal" === this.orientation && this.range.stop(1, 1)[c ? "animate": "css"]({
                        width: 100 - i + "%"
                    },
                    r.animate), "min" === s && "vertical" === this.orientation && this.range.stop(1, 1)[c ? "animate": "css"]({
                        height: i + "%"
                    },
                    r.animate), "max" === s && "vertical" === this.orientation && this.range.stop(1, 1)[c ? "animate": "css"]({
                        height: 100 - i + "%"
                    },
                    r.animate))
                },
                _handleEvents: {
                    keydown: function(e) {
                        var i, o, n, a = t(e.target).data("ui-slider-handle-index");
                        switch (e.keyCode) {
                        ...
                        switch (n = this.options.step, i = o = this._hasMultipleValues() ? this.values(a) : this.value(), e.keyCode) {
                        case t.ui.keyCode.HOME:
                            o = this._valueMin();
                            break;
                        case t.ui.keyCode.END:
        ...
        "use strict"; (function(e, o) {
            ...
            n = {
                ...
                _constrainDraggableOptionsIfNeeded: function(t) {
                    return e.enabled("constraint_dialogs_movement") && (t.containment = ".chart-page"),
                    t
                },
                showNotice: function(t, e, i) {
                    ...
                    n.modalDialog.find("._tv-dialog-content").html(o.render('<div class="main"><div class="{{captionClassName}} {{classSuffix}}">{{text}}' + s + '</div>{{^removeOkButton}}<div class="buttons"><input type="button" class="_tv-button ok" value="' + p + '"/></div>{{/removeOkButton}}</div>', {
                        captionClassName: c,
                        classSuffix: i.classSuffix || "",
                        text: e,
                        removeOkButton: i && i.removeOkButton
                    })),
                    n.modalDialog.find("._tv-button.ok").on("click",
                    function() {
                        n.destroy(),
                        i.onOkButtonClick && i.onOkButtonClick()
                    }),
                    n.positionDialog(),
                    n.applyHandlers(!1, {
                ...
                showCustomDialog: function(t) {
                    ...
                    return n.createModalDialog(t.title || $.t("Dialog"), {
                        addClass: ""
                    }),
                    n.modalDialog.find("._tv-dialog").css("width", t.width || "400px"),
                    n.modalDialog.find("._tv-dialog-content").html('<div class="main">' + (t.html || $.t("Content")) + "</div>"),
                ...
                createModalDialog: function(t, e) {
                    ...
                    n.modalDialog = $('<div class="_tv-dialog-shadowbox"><div class="_tv-dialog _tv-dialog-modal' + (e.addClass ? " " + e.addClass: "") + '">' + (e.noHeader ? "": '<div class="_tv-dialog-title">' + (e.noClose ? "": '<a class="_tv-dialog-title-close"></a>') + '<span class="_tv-dialog-title-text">' + t + "</span></div>") + '<div class="_tv-dialog-error"><span class="message"></span></div><div class="_tv-dialog-message"><span class="message"></span></div><div class="_tv-dialog-content"></div></div></div>').appendTo($("body")).data("title", t),
                    ...
                    e.width && n.modalDialog.find("._tv-dialog").css({
                        width: e.width
                    }),
                    e.content && n.modalDialog.find("._tv-dialog-content").html(e.content),
                    i = $(".fancybox-overlay"),
                    i.length && (o = i.css("z-index"), $("._tv-dialog-shadowbox").css("z-index", o + 1)),
                    e.draggable && s(n.modalDialog).draggable(n._constrainDraggableOptionsIfNeeded({
                ...
                createDialog: function(t, e) {
                    var i, r, l, c;
                    return n.isOpen(t) ? (i = n.get(t), i.find("._tv-dialog-content").html(""), i.data("new", !1), i) : (e = e || {},
                    r = e.ownerDocument || document, i = $(o.render('<div class="_tv-dialog _tv-dialog-nonmodal {{&addClass}}"><div class="_tv-dialog-title{{#hideTitle}} _tv-dialog-title-hidden{{/hideTitle}}{{#hideCloseCross}} _tv-dialog-title-no-close{{/hideCloseCross}}">{{^hideTitle}} {{&title}}{{/hideTitle}}{{^hideCloseCross}}<a class="_tv-dialog-title-close"></a>{{/hideCloseCross}}</div><div class="_tv-dialog-error"><span class="message"></span></div><div class="_tv-dialog-message"><span class="message"></span></div><div class="_tv-dialog-content"></div></div>', {
                        addClass: e.addClass || "",
                        hideTitle: e.hideTitle,
                        hideCloseCross: e.hideCloseCross,
                        title: t
                    }), r).appendTo(r.body), n._addMessageCloseButton(i.find("._tv-dialog-error")), n._addMessageCloseButton(i.find("._tv-dialog-message")), e.width && i.css({
                        width: e.width
                    }), e.content && i.find("._tv-dialog-content").html(e.content), l = 0, l = e.zIndex ? e.zIndex: n.dialogs && n.dialogs.length ? a($.map(n.dialogs,
                    function(t) {
                        return parseInt((t.dialog || t).css("z-index"), 10)
                    })) + 1 : 110, i.css("z-index", l), i.data("new", !0), i.data("title", t), i.data("id", n.dialogs.length + 1), n.dialogs.push({
                        title: t,
                        dialog: i,
                        id: n.dialogs.length + 1
                    }), c = {
                        start: function(t, e) {
                            var i, o, a = e.helper.css("z-index"),
                            s = 0,
                            r = null;
                            for (i = 0; i < n.dialogs.length; i++)(o = n.dialogs[i].dialog.css("z-index")) > s && (s = o, r = n.dialogs[i].dialog);
                            e.helper.css("z-index", s),
                            r.css("z-index", a)
                        }
                    },
                    e.dragHandle ? c.handle = e.dragHandle: e.hideTitle || (c.handle = "._tv-dialog-title"), e.dragOptions && $.extend(c, e.dragOptions), s(i).draggable(n._constrainDraggableOptionsIfNeeded(c)), i)
                },
                positionDialog: function(t, e, i) {
                    ...
                    i = i || {},
                    e = e || i.position,
                    t ? (s = t.prop("ownerDocument"), r = s.defaultView, l = t.width(), c = t.height(), p = $(r).width(), u = $(r).height(), e && e.top && e.left ? (h = i.forcePosition ? e.left: Math.max(2, Math.min(p - l - 4, e.left)) + "px", d = i.forcePosition ? e.top: Math.max(2, Math.min(u - c - 4, e.top)) + "px") : e && e.considerScroll ? (f = $(s), h = Math.round((p - l) / 2 + f.scrollLeft()) + "px", d = Math.round((u - c) / 2 + f.scrollTop()) + "px") : (h = Math.round((p - l) / 2) + "px", d = Math.round((u - c) / 2) + "px"), i.fadeIn ? t.css({
                        left: h,
                        top: d
                ...
                applyHandlers: function(t, e) {
                    var i, o, a, s = !t || t === this.modalDialog;
                    e = e || {},
                    i = s ?
                    function() {
                        n.destroy()
                    ...
                    t.find("._tv-dialog-title ._tv-dialog-title-close, .js-dialog-close").on("click",
                    function(t) {
                        e.closeHandler && "function" == typeof e.closeHandler ? e.closeHandler(t) : i()
                    }),
                    e.doNotCloseOnBgClick || setTimeout(function() {
                        $(o).on("mousedown.closeDialog",
                        function(n) {
                            var a = $(n.target).parents().andSelf();
                            a.is(t) || e.doNotCloseOnBgClickIfShadowbox && a.is("._tv-dialog-shadowbox, .tv-dialog__modal-wrap") || a.is(".colorpicker, .charts-popup-list, ._tv-dialog, .tvcolorpicker-popup, .symbol-edit-popup, .ui-datepicker, .clockpicker-popover, .pac-container") || ($(o).off("mousedown.closeDialog"), i())
                        })
                    },
                    0),
                    ...
                    a = t.find('input[type="text"]').focus(function() {
                    ...
                    e.doNotCloseOnEsc || $(o).bind("keyup.hideDialog",
                    function(e) {
                        if (27 === e.keyCode) return t ? n.destroy(t.data("title")) : n.destroy(),
                        !1
                    }),
                    e.processEnterButton && $(o).bind("keyup.confirmAndCloseDialog",
                    function(t) {
                        13 === t.keyCode && "textarea" !== t.target.tagName.toLowerCase() && (e.processEnterButton.click(), $(o).unbind("keyup.confirmAndCloseDialog"))
                    })
                },
                showError: function(t, e, i) {
                    n.showMessage(t, e, $.extend(i || {},
                    {
                        isError: !0
                    }))
                },
                showMessage: function(t, e, i) {
                    ...
                    a.toggleClass("with-close", !!i.withClose).css({
                        marginTop: n.NOTIFICATION_ANIMATION_START_OFFSET,
                        opacity: "0"
                    }).show().animate({
                        marginTop: 0,
                    ...
                    "fast"),
                    i.withClose || (i.hideWithoutAnimation ? a.on("touchstartoutside mousedownoutside keydownoutside",
                    function t() {
                        a.hide(),
                        a.off("touchstartoutside mousedownoutside keydownoutside", t)
                    }) : a.on("touchstartoutside mousedownoutside keydownoutside",
                    function t() {
                        a.animate({
                            marginTop: n.NOTIFICATION_ANIMATION_START_OFFSET,
                            opacity: 0
                ...
                get: function(t) {
                    for (var e = 0; e < n.dialogs.length; e++) if (n.dialogs[e].title === t) return n.dialogs[e].dialog
                },
                destroy: function(t, e) {
                    var i, o = null;
                    if (t && "string" == typeof t) for (i = 0; i < n.dialogs.length; i++) n.dialogs[i].title === t && (o = n.dialogs[i].dialog.prop("ownerDocument"), n.dialogs[i].dialog.find(".apply-common-tooltip").mouseout(), n.dialogs[i].dialog.trigger("destroy", e), $(document).unbind("mouseup.hideDialog" + n.dialogs[i].id), $("input", n.dialogs[i].dialog).blur(), n.dialogs[i].dialog.remove(), n.dialogs.splice(i, 1));
                    else n.modalDialog && (o = n.modalDialog.prop("ownerDocument"), n.modalDialog.find(".apply-common-tooltip").mouseout(), n.modalDialog.find("._tv-dialog").trigger("destroy"), n.modalDialog.remove(), n.modalDialog = null);
                    $(o).unbind("keyup.hideDialog"),
                    $(o).unbind("keyup.confirmAndCloseDialog")
                },
    ...
    964 : function(t, e, i) {
        "use strict"; (function(e) {
            ...
            o.prototype.loadData = function() {
                var t = this;
                return this._toolName in o._cache ? (this._list = o._cache[this._toolName], $.Deferred().resolve()) : $.get("/drawing-templates/" + this._toolName + "/",
                function(e) {
                    t._list = e,
                    o._cache[t._toolName] = e
                }).error(function() {
            ...
            o.prototype.createButton = function(t) {
                ...
                return t = $.extend({},
                t, i._options),
                e = $("<a></span></a>").addClass(t.buttonClass ? t.buttonClass: "_tv-button").html(t.buttonInner ? t.buttonInner: $.t("Template") + '<span class="icon-dropdown">'),
                n(e, null, {
                    event: "button-popup",
                ...
                function(e) {
                    var o, n, a;
                    e.stopPropagation(),
                    $(this).is("active") || (o = [], "function" == typeof t.getDataForSaveAs && (n = function(e) {
                        ...
                        a.push({
                            ...
                            deleteAction: function() {
                                runOrSignIn(function() {
                                    var t = $.t("Do you really want to delete Drawing Template '{0}' ?").format(o);
                                    l({
                                        type: "modal",
                                        content: t
                                    }).then(function(t) {
                    ...
                    }), a.length && (a.sort(function(t, e) {
                        return t = t.title.toUpperCase(),
                        e = e.title.toUpperCase(),
                        t === e ? 0 : t > e ? 1 : -1
                    }), o.push({
                        separator: !0
                    }), o = o.concat(a)), $(this).trigger("button-popup", [o]))
                }),
                e
            },
            o.prototype.loadTemplate = function(t, e) {
                var i = this;
                return $.get("/drawing-template/" + this._toolName + "/?templateName=" + encodeURIComponent(t),
                function(t) {
                    i._applyTemplate(JSON.parse(t.content)),
                    e && e()
                }).error(function(t) {
            ...
            o.prototype.saveTemplate = function(t, e) {
                var i, o = this;
                t && e && (t = TradingView.clean(t), i = -1 !== $.inArray(t, o._list),
                function() {
                    var n = {
                        name: t,
                        tool: o._toolName,
                ...
                n = new s({
                    ...
                    confirm: {
                        ...
                        getMessage: function(t) {
                            return $.t("Drawing Template '{0}' already exists. Do you really want to replace it?").format(o(t))
                        }
                    }
                });
                runOrSignIn(function() {
